 function Napitak( oznakaNapitka,ime,datum,smrtonosan)
 {
	var that=this;
	this.oznakaNapitka=oznakaNapitka;
	this.ime=ime;
	this.datum=datum;
	...
	(function(){
		 if(that.oznakaNapitka===null || that.oznakaNapitka===undefined || that.oznakaNapitka==="")
			 that.oznakaNapitka="bez oznake";
		 if(that.ime===null || that.ime===undefined || that.ime==="")
			 that.ime="bez imena";
